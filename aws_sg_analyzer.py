...
def generate_security_groups_portscanning_report_by_region(region):
    ...
    for sg in sgList:
        ...
        print(bColors.Cyan + f"Loading EC2 Instances in security group {sg[0]} ..." + bColors.ENDC)
        cell_format = workbook.add_format()
...
try:
    ...
    if len(aws_profiles) == 1:
        ...
        terminal_menu = TerminalMenu(aws_profiles)
        menu_entry_index = terminal_menu.show()

        print(f"Selected aws profile: {aws_profiles[menu_entry_index]} \n")
        selected_profile = aws_profiles[menu_entry_index]
